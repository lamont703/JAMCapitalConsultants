...
${reportData}`;
    ...
    console.error("Error analyzing credit reports:", error);
    throw new Error("Failed to analyze credit reports");
  }
}

// Helper function to extract summary from analysis text
